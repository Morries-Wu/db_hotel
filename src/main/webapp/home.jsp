...
<div class="layui-header header header-store" style="background-color: #393D49;">
    <div class="layui-container">
        ...
        <ul class="layui-nav" id="layui-nav-userinfo">
            <li data-id="index" class="layui-nav-item layui-hide-xs layui-this"><a class="fly-case-active" data-type="toTopNav" href="${pageContext.request.contextPath}/index.html">首页</a></li>
            <li data-id="room" class="layui-nav-item layui-hide-xs"><a class="fly-case-active" data-type="toTopNav" href="${pageContext.request.contextPath}/room/list.html">房间</a></li>
            <li data-id="login" class="layui-nav-item layui-hide-xs "><a class="fly-case-active" data-type="toTopNav" href="${pageContext.request.contextPath}/login.jsp">登入</a></li>
            <li data-id="register" class="layui-nav-item layui-hide-xs "><a class="fly-case-active" data-type="toTopNav" href="${pageContext.request.contextPath}/register.jsp">注册</a></li>
...
<div class="shop-nav shop-index">
    ...
    <div class="shop-banner">
                ...
                <dl id="getIndexRoomType">
                    ...
                    <c:forEach var="roomType" items="${roomTypeList}">
                        <dd data-id="${roomType.id}">
                            <a class="fly-case-active" href="${pageContext.request.contextPath}/room/list/${roomType.id}"
        ...
        <div class="layui-carousel" lay-filter="LAY-store-banner" id="LAY-store-banner" lay-anim lay-indicator="inside" >
            <div carousel-item>
                <div class="">
                    <div class="layui-container"><a href="javascript:;" target="_blank"> <img src="${pageContext.request.contextPath}/statics/front/images/7.png"
                                                                                              alt="酒店系统"> </a></div>
                </div>
                <div class="">
                    <div class="layui-container"><a href="javascript:;" target="_blank"> <img src="${pageContext.request.contextPath}/statics/front/images/3.jpg"
                                                                                              alt="酒店系统"> </a></div>
                </div>
                <div class="layui-this">
                    <div class="layui-container"><a href="javascript:;" target="_blank"> <img src="${pageContext.request.contextPath}/statics/front/images/4.jpg"
                                                                                              alt="酒店系统"> </a></div>
                </div>
                <div class="">
                    <div class="layui-container"><a href="javascript:;" target="_blank"> <img src="${pageContext.request.contextPath}/statics/front/images/5.jpg"
                                                                                              alt="酒店系统"> </a></div>
                </div>
                <div class="">
                    <div class="layui-container"><a href="javascript:;" target="_blank"> <img src="${pageContext.request.contextPath}/statics/front/images/1.jpg"
                                                                                              alt="酒店系统"> </a></div>
                </div>
                <div class="">
                    <div class="layui-container"><a href="javascript:;" target="_blank"> <img src="${pageContext.request.contextPath}/statics/front/images/6.jpg"
                                                                                              alt="酒店系统"> </a></div>
                </div>
            </div>
                        ...
                        <div class="layui-row layui-col-space20">
                            <c:forEach var="room" items="${roomList}">
                                ...
                                <div data-id="${room.id}" class="layui-col-xs6 layui-col-md3">
                                    <a class="template store-list-box fly-case-active" href="${pageContext.request.contextPath}/room/${room.id}.html" data-type="toRoomInfo">
...
<div class="fly-footer">
    ...
    <p>
        友情链接
        <a href="https://github.com/Morries-Wu?tab=repositories" target="_blank">作者GitHub</a>
        <a href="https://space.bilibili.com/435453411?spm_id_from=333.788.0.0" target="_blank">作者B站</a>
        <a href="https://blog.csdn.net/weixin_46370979?spm=1000.2115.3001.5343" target="_blank">作者博客</a> </p>
</div>

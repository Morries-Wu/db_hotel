...
<div class="layui-header header header-store" style="background-color: #393D49;">
    <div class="layui-container">
        ...
        <ul class="layui-nav" id="layui-nav-userinfo">
            ...
            <li data-id="register" class="layui-nav-item layui-hide-xs layui-this"><a class="fly-case-active" data-type="toTopNav" href="${pageContext.request.contextPath}/register.jsp">注册</a></li>
...
<!-- 脚本开始 -->
<script src="${pageContext.request.contextPath}/statics/front/layui/dist/layui.js" type="text/javascript"></script>
<script>

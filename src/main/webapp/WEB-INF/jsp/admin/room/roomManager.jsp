...
<script>
    layui.use(['form', 'table', 'laydate', 'jquery', 'layer','upload','layedit'], function () {
        ...
        //查询楼层下拉列表
        $.get("${pageContext.request.contextPath}/admin/floor/findAll",function (result){
            var html="";
            for (var i=0;i<result.length;i++){
        ...
        * */
        ...
        function openAddWindow() {
            ...
            detailIndex=layedit.build("roomdesc",{
                uploadImage:{
                    url:"${pageContext.request.contextPath}/admin/file/uploadFile",//文件上传地址
                    type:"post"//提交方式
                }
            });
        }
        ...
        upload.render({
            elem:".thumbImg",//绑定元素
            url:"${pageContext.request.contextPath}/admin/file/uploadFile",//文件上传地址
            accpetMime:"imag/*",//规定打开文件选择框时,筛选出的文件类型

            ...
            <form class="layui-form" style="width:90%;" id="dataFrm" lay-filter="dataFrm">
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="phone" placeholder="请输入手机号码" lay-verify="required"
                                   readonly autocomplete="off" readonly class="layui-input">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item">
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="payprice" placeholder="请输入支付金额" lay-verify="required"
                                  id="payprice" readonly autocomplete="off" class="layui-input">
                        </div>
                    </div>
                    <div class="layui-inline">
                        <label class="layui-form-label">退款金额</label>
                        <div class="layui-input-inline">
                            <input type="text" name="outprice" id="outprice" placeholder="请输入退款金额" lay-verify="required"
                                  value="0" readonly autocomplete="off" class="layui-input">
                        </div>
                    </div>
                </div>
                <%--隐藏域,房间价格--%>
                ...
                <div class="layui-form-item">
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="arrivedate" placeholder="请选择入住日期" readonly autocomplete="off"
                                  id="arrivedate" class="layui-input">
                        </div>
                    </div>
                    ...
                    <div class="layui-inline">
                        <label class="layui-form-label">离店日期</label>
                        <div class="layui-input-inline">
                            <input type="text" name="leavedate" lay-verify="required" autocomplete="off"  placeholder="请选择退房日期范围"
                                  id="leavedate" class="layui-input">
                        </div>
                    </div>
...
<script>
    layui.use(['form', 'table', 'laydate', 'jquery', 'layer'], function () {
        ...
        var tableIns = table.render({
            ...
            cols: [[
                ...
                {field: 'payprice', width: 120, title: '支付金额', align: "center"},
                {
                    ...
                    align: "center",
                    templet: function (d) {
                        return layui.util.toDateString(d.arrivedate, 'yyyy-MM-dd');
                    }
                },
                {
                    field: 'leavedate',
                    ...
                    align: "center",
                    templet: function (d) {
                        return layui.util.toDateString(d.leavedate, 'yyyy-MM-dd');
                    }
                },
                {field: 'outprice', width: 120, title: '退款金额', align: "center",
                    templet: function (d) {
                        return d.outprice  ?"<font color='red'>"+d.outprice+"</font>"  : "0";
                    }
                },
                {title: '操作', width: 150, toolbar: '#currentTableBar', align: "center"},
                {
                    field: 'price', width: 100, title: '入住房型', align: "center", templet: function (d) {
                ...
                yes: function (index, layero) {
                    ...
                    if (checkStatus.data.length > 0) {
                        ...
                        form.val("dataFrm", {
                            ...
                            , "arrivedate": layui.util.toDateString(data.arrivedate, 'yyyy-MM-dd') //入住日期
                            , "leavedate": layui.util.toDateString(data.leavedate, 'yyyy-MM-dd')    //离店日期
                            , "idcard": data.idcard  //身份证号码
                            , "remark": data.remark //备注
                            , "price":data.roomType.price/*租房初值*/
                        });
                        //关闭窗口
                        layer.close(index);
                    } else {
        ...
        function initOrdersTable() {
            table.render({
                ...
                cols: [[
                    ...
                    {
                        field: 'arrivedate', width: 110, title: '入住日期', align: "center", templet: function (d) {
                            return layui.util.toDateString(d.arrivedate, 'yyyy-MM-dd');
                        }
                    },
                    {
                        field: 'leavedate', width: 110, title: '离店日期', align: "center", templet: function (d) {
                            return layui.util.toDateString(d.leavedate, 'yyyy-MM-dd');
                        }
                    },
                    {field: 'outprice', width: 80, title: '退款金额', align: "center"},
                    {
                        field: 'price', width: 100, title: '预定初值', align: "center", templet: function (d) {
                            return d.roomType.price?d.roomType.price:"0";
                        }
                    },
                ]],
                page: true,
                done: function () {
                    $("[data-field='outprice'],[data-field='price']").css('display','none');
                }
            });
        }
                ...
                mainIndex = layer.open({
                    ...
                    success: function () {
                        ...
                        form.val("dataFrm", {
                            ...
                            , "idcard": data.idcard  //身份证号码
                            , "remark": data.remark //备注
                            , "price":data.roomType.price?data.roomType.price:"0"
                        });//参数1:lay-filter值 参数2:回显的数据
                        //添加的提交请求
                        url = "${pageContext.request.contextPath}/admin/checkout/updateCheckin?id="+data.id
                    }
                });
        ...
        /*值发生改变的时候触发事件*/
        $("#leavedate").bind("input propertychange",function (){
            var arrivedate = $("#arrivedate").val();
            var leavedate = $("#leavedate").val();
            var day = getDays(arrivedate,leavedate);
            //赋值入住天数
            $("#day").val(day);
            //计算房费价格
            var price = day * $("#price").val();
            var total=  $("#payprice").val();

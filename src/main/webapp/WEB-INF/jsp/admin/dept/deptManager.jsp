                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-inline">
                            ...
                            <button type="reset" class="layui-btn layui-btn-warm"><i
                                    class="layui-icon layui-icon-return"></i> 重 置
                            </button>
                        </div>
                    </div>
                </form>
        ...
        <div style="display: none;padding: 5px" id="addOrUpdateWindow">
            <form class="layui-form" style="width:90%;" id="dataFrm" lay-filter="dataFrm">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                      <textarea class="layui-textarea" name="remark" id="content">
                      </textarea>
                    </div>
                </div>
    ...
    layui.use(['form', 'table', 'layer'], function () {
        ...
        var tableIns = table.render({
            ...
            cols: [[
                ...
                {field: 'createDate', minWidth: 120, title: '创建时间', align: "center",templet: "<div>{{layui.util.toDateString(d.createDate, 'yyyy-MM-dd')}}</div>"},
        ...
        * */
        ...
        function deleteById(data){
            //判断是否存在员工
            $.get("${pageContext.request.contextPath}/admin/dept/checkDeptHasEmployee",{id:data.id},function (result){
                if(result.exist){
                    //提示用户无法删除
                    ...
                    layer.confirm("确定要删除[<font color='red'>"+data.deptName+"</font>]吗",{icon:3,title:'提示'},function (index){
                        //发送ajax请求进行删除
                        $.post("${pageContext.request.contextPath}/admin/dept/deleteById",{"id":data.id},function (result){
                            if(result.success){
                                //刷新数据表格
                                tableIns.reload();
                            }

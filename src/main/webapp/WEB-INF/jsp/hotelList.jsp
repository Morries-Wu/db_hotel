...
<div class="layui-header header header-store" style="background-color: #393D49;">
    <div class="layui-container">
        ...
        <ul class="layui-nav" id="layui-nav-userinfo">
            <li data-id="index" class="layui-nav-item layui-hide-xs "><a class="fly-case-active" data-type="toTopNav" href="${pageContext.request.contextPath}/index.html">首页</a></li>
            <li data-id="room" class="layui-nav-item layui-hide-xs layui-this"><a class="fly-case-active" data-type="toTopNav" href="${pageContext.request.contextPath}/room/list.html">房间</a></li>
            ...
            <div class="layui-card-body">
                <div class="store-cat-item"> <span><i class="layui-icon layui-icon-shop-fenlei"></i>类别：</span>
                    <ul id="getAllRoomType">
                        ...
                        <li data-id="0" <c:if test="${typeId==null}">class="active"</c:if>> <a class="fly-case-active" href="${pageContext.request.contextPath}/room/list.html" data-type="toRoomTypeListByLists">全部</a></li>
                        <c:forEach var="roomType" items="${roomTypeList}">
                            <%--判断typeId房型ID值是否与房型列表中ID值相等,相等则选择该超链接,设置字体颜色为绿色--%>
                            <li data-id="${roomType.id}" <c:if test="${typeId==roomType.id}">class="active"</c:if>> <a class="fly-case-active" href="${pageContext.request.contextPath}/room/list/${roomType.id}" data-type="toRoomTypeListByLists">${roomType.typename}</a> </li>
                        </c:forEach>
                    </ul>
                </div>
                <div class="store-cat-item colorFilt"> <span><i class="layui-icon layui-icon-shop-color"></i>楼层：</span>
                    <ul id="getAllFloor"><li style="background: #f2f2f2" title="全部">
                        ...
                        <img src="${pageContext.request.contextPath}/statics/front/images/all_bg.jpg"><i class="layui-icon layui-icon-ok">
                        </i></a></li>
                ...
                <a class="template store-list-box fly-case-active" href="${pageContext.request.contextPath}/room/${room.id}.html" data-type="toRoomInfo">
                    ...
                    <div> <label class="layui-badge-rim store-list-pay"> ￥${room.price} </label>
                        <div class="store-list-colorbar">
                            <span class="store-color-bar" style="position: relative;bottom: 2px; border-color: #009688;color: #009688;border-width: 1px;border-style: solid;background-color: #fff;   text-align: center;">NO.${room.roomnum}</span>

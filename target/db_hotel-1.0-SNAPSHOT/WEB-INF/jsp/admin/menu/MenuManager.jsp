    ...
    <div class="layuimini-main">
        <div class="layui-row">
            ...
            <div class="layui-col-md2">
                <!-- 树节点容器开始 -->
                <ul id="menuTree" class="dtree" data-id="0" style="width: 200px;"></ul>
                <!-- 树节点容器结束 -->
            </div>
...
<script>
    layui.extend({
       ...
       var menuTree=dtree.render({
            ...
            url: "${pageContext.request.contextPath}/admin/menu/loadMenuTree", //请求地址
        ...
        var tableIns = table.render({
            ...
            cols: [[
                ...
                {field: 'icon', width: 150, title: '菜单图标', align: "center",templet:function (d){
        ...
        dtree.on("node(menuTree)",function (obj){
            tableIns.reload({
                where:{"id":obj.param.nodeId},//其中nodeId属性就是选中节点的id值
                page:{curr:1}
            });
        });
        ...
        function openUpdateWindow(data){
            mainIndex = layer.open({
                ...
                success: function () {
                    ...
                    //修改的提交请求
                    url = "${pageContext.request.contextPath}/admin/menu/updateMenu";
                    //图标回显
        ...
        function deleteById(data){
            $.get("${pageContext.request.contextPath}/admin/menu/checkMenuHasChild",{"id":data.id},function (result){
                ...
                if (result.exist){
                    ...
                    //提示用户是否删除该部门
                     layer.confirm("确定要删除[<font color='red'>"+data.title+"</font>]吗",{icon:3,title:'提示'},function (index){
                        //发送ajax请求进行删除该菜单
                        $.post("${pageContext.request.contextPath}/admin/menu/deleteById",{"id":data.id},function (result){
                            if(result.success){
                                //刷新数据表格
                                tableIns.reload();
                                //刷新左侧菜单树
